...
const configuration = new Configuration({ // organization: "org-yR4wdkzoY6o2ibaWM64CusQ5",
...
app.post(URL, async (req, res) => { // console.log(req.body);
    ...
    try {
        ...
        if (commands[text]) {
            ...
            const reply = await openai.createCompletion({
                max_tokens: 4000, model: "text-davinci-003", // "ada",
                prompt: text,
                temperature: 0.5
            });
